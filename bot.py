...
class Bot(BaseBot):
    ...
    async def on_chat(self, user: User, message: str, **kwargs):
        ...
        # ===== HELP =====
        if msg == "/help" or msg == "help" or msg == "команды":
            help_text = (
                "📜 СПИСОК КОМАНД\n\n"
                "✨ ОСНОВНЫЕ:\n"
                "• list — список анимаций\n"
                "• 1-252 — запустить анимацию\n"
                "• 0 — остановить\n"
            ...
            if await self.is_admin(user):
                help_text += (
                    ...
                    "• /одежда — изменить одежду\n"
                    "• /позиция — позиция бота"
                )
